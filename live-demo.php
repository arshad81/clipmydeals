...
<div class="card bg-dark text-white rounded-0 hp-slider">
    ...
    <div class="card-img-overlay container-lg d-flex flex-column justify-content-center mt-5">
        ...
        <div class="d-flex justify-content-center my-md-3">
            <button class="btn btn-primary my-2 mx-2 px-sm-3 py-sm-2 px-md-4 py-md-3"> <img class="me-1" src="./assets/images/icons/buy-now-icon.svg" alt="buy-now" width="14" height="14"> Buy Now</button>
        </div>
    </div>
</div>
<div class="container-xl mt-4">
    <p class="h5 fs-md-3 text-center">Demo Websites</p>
    <p class="fw-light h6 fs-md-5 w-md-75 w-lg-50 mx-auto text-center pb-lg-3">NOTE: Demo websites are created to showcase how you can build a fully functional website using ClipMyDeals Theme & Plugins. To demonstrate certain common website functionalities like Social Login, Newsletters, etc. we have used some free third-party WordPress plugins as well. Please read demo website documentation to know more. We do not recommend or restrict the use of any specific plugin with ClipMyDeals. You are free to implement the same features with other plugins that you may prefer.</p>
</div>
<section class="container-xl mt-5 text-center">
    <p class="h5 fs-md-3 text-center ">Browse by Website Features</p>
    <div class="row row-cols-2 row-cols-md-3 g-1 g-xl-4 my-2 justify-content-center w-xl-75 mx-xl-auto">
        <div class="col">
...
<section class="container-xl mt-4 text-center bg-custom-pink rounded-5 py-4">
    <p class="h5 fs-md-3 text-center mb-4">Browse by Languages</p>
    <div class="row row-cols-2 row-cols-md-3 g-3 my-2 w-xl-75 mx-auto">
        <div class="col">
            <div class="card p-1">
    ...
    <p class="h5 fs-md-3 text-center my-4">Browse by Welcome Type</p>
    <div class="row row-cols-2 row-cols-md-3 g-3 w-xl-75 mx-auto">
        <div class="col">
            <div class="card p-1">
...
<section class="container-xl mt-4 text-center">
    <p class="h5 fs-md-3 text-center">Browse by Offer Layouts</p>
    <div class="row row-cols-2 row-cols-md-3 g-3 my-2 w-xl-75 mx-auto">
        <div class="col">
...
<section class="container-xl mt-4 text-center ">
    <p class="h5 fs-md-3 text-center">Options to Reveal Coupons</p>
    <div class="row row-cols-2 my-2 row-cols-md-3 g-3 w-xl-75 mx-auto">
        <div class="col">
            <div class="card bg-light p-1">
...
<section class="container-xl bg-custom-pink rounded-5">
    <section class=" mt-4 text-center  py-5">
        <p class="h5 fs-md-3 text-center">Other Pages</p>
        <div class="row row-cols-2 my-2 row-cols-md-3 g-3 w-xl-75 mx-auto">
            <div class="col">
                <div class="card">
                    <img src="./assets/images/Live-demo/multislides.jpg" class="card-img-top mw-100 h-auto rounded-3" width="336" height="193" alt="alt text">
        ...
        <div>
            <p class="h5 fs-md-3 text-center mt-5 ">Explore Add-Ons</p>
            <div class="row g-3 mx-auto align-items-end py-0 mt-4">
                <div class=" col-6 ">
                    <img src="./assets/images/Live-demo/mobile.png" class=" py-0 w-50 w-md-25 h-auto rounded-3" width="144" height="148" alt="alt text">
                    <p class="h6 card-text mt-3">Android App Demo</p>
                    <button class="btn btn-primary my-2"><img class="me-1" src="./assets/images/icons/triangle play button.svg" alt="buy-now" width="14px">View Demo</button>
                </div>
                <div class="col-6">
                    <img src="./assets/images/Live-demo/IOS-mobile.png" class=" rounded mw-100 h-auto-3 w-50 w-md-25 h-auto" width="153" height="143" alt="alt text">
                    <p class="h6 card-text mt-3">IOS App Demo</p>
                    <button class="btn btn-primary my-2 "><img class="me-1" src="./assets/images/icons/triangle play button.svg" alt="buy-now" width="14px">View Demo</button>
                </div>
            </div>
        </div>
