    ...
    <div class="carousel-inner ">
        <div class="carousel-item active">
            ...
            <div class="position-absolute top-0 start-50 translate-middle-x  w-100">
                <p class="h1 text-custom-white text-center text-md-start mx-auto mt-4 lh-sm carousel-text">The Most comprehensive affiliate theme for Wordpress</h1>
                <div class="d-flex justify-content-center mt-6p ">
                    <button class="btn btn-outline-light btn-sm-lg mx-2 watch-btn"> <img class="me-1 " src="./assets/images/icons/btn-video.svg" alt="buy-now" width="14px"> Watch Video</button>
                    <button class="btn btn-primary btn-sm-lg mx-2"> <img class="me-1" src="./assets/images/icons/buy-now-icon.svg" alt="buy-now" width="14px"> Buy Now</button>
                </div>
                <div class="mt-sm-3">
